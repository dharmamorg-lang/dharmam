        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8">
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex gap-3 mt-5">
              {[
                { icon: 'GlobeAltIcon', label: 'Website', href: 'https://www.dharmam.org' },
              ].map((s) => (
                <a
                  key={s.label}
                  href={s.href}
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/dharmam_trust"
                target="_blank"
              ...
              {/* LinkedIn */}
              <a
                href="https://in.linkedin.com/in/dharmam-charitable-trust-415a183b3"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:text-white hover:border-white/60 transition-all"
              ...
              {/* YouTube */}
              <a
                href="https://youtube.com/@dharmamcharitabletrust"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:text-white hover:border-white/60 transition-all"
