        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12">
            <div className="rounded-2xl overflow-hidden aspect-video relative">
              <img
                src="https://img.rocket.new/generatedImages/rocket_gen_img_117de1dfe-1767706720499.png"
                alt="Indian students studying in a classroom supported by Dharmam Charitable Trust"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
              
            </div>
            <div className="rounded-2xl overflow-hidden aspect-video relative">
              <img
                src="https://img.rocket.new/generatedImages/rocket_gen_img_13caaca22-1773830672825.png"
                alt="Indian teacher empowering students with modern teaching methods in Tamil Nadu"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            ...
            <div className="rounded-2xl overflow-hidden aspect-video relative">
              <img
                ...
                alt="School infrastructure development and community programs by Dharmam Trust in Chennai"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
